...
/*
 * Initialize the ATD converter with a synchronization primitive, which
 * is used to prevent preemption between tasks sharing the ATD converter.
 */

void ATDInit(OS_EVENT*);
